      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 flex-grow mb-6">
        <Card className="col-span-1 p-4 border-border bg-card/50 backdrop-blur-sm hidden lg:block">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-xl font-semibold">{t('chat.history', 'History')}</h2>
            <Button
              variant="outline"
              size="sm"
              className={cn(
                "h-8 px-3 gap-2 border-[#00F7FF]/40 hover:border-[#00F7FF] hover:bg-[#00F7FF]/10 transition-all duration-200",
                isCurrentChatNew() && "opacity-50 cursor-not-allowed hover:bg-transparent hover:border-[#00F7FF]/40"
              )}
                ...
                {history.isEditing ? (
                  ...
                  <div className="flex items-center justify-between">
                    <Button
                      variant="outline"
                      className={cn(
                        "w-full justify-start group-hover:pr-8",
                        currentChatId === history.id && "bg-[#00F7FF]/10 border-[#00F7FF]/40"
                      )}
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 absolute right-0 opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                          <MoreVertical className="h-4 w-4" />
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => handleStartEditing(history)}>
        ...
        <Card className="col-span-1 lg:col-span-3 flex flex-col border-border bg-card/50 backdrop-blur-sm overflow-hidden h-[calc(100vh-200px)]">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-none p-4 border-t border-gray-200 bg-gray-50/50">
              <div className="relative">
                ...
                <div className="absolute right-3 bottom-3 flex items-center gap-2">
                  <Button
                    variant="outline"
                    size="icon"
                    className="rounded-full h-8 w-8 border-gray-200 hover:border-[#00F7FF]/40 hover:bg-[#00F7FF]/10 transition-all duration-200"
                  >
                  ...
                  <Button
                    ...
                    className=" h-8 w-8 border-gray-200 hover:border-[#00F7FF]/40 hover:bg-[#00F7FF]/10 transition-all duration-200 block p-0 mx-auto"
                  >
              ...
              <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                <div className="flex items-center gap-2">
                  <button className="flex items-center hover:text-[#00F7FF] transition-colors">
