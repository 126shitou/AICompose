        ...
        try {
          ...
          if (!dbUser) {
            dbUser = await User.create({
              ...
              credits: 100, // 新用户赠送积分
              emailVerified: new Date(), // 谷歌账户默认邮箱已验证
        ...
        try {
          ...
          if (user) {
            ...
            session.user.usageStats = {
              totalGenerations: user.usageStats.imagesGenerated + user.usageStats.videosCreated + user.usageStats.musicGenerated + user.usageStats.audioGenerated,
              imageGenerations: user.usageStats.imagesGenerated,
              audioGenerations: user.usageStats.audioGenerated,
              videoGenerations: user.usageStats.videosCreated,
              chatMessages: user.usageStats.chatMessages,
            };
          }
        } catch (error) {
